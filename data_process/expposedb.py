...
class ExpPoseDB(data.Dataset):
    def __init__(self,config,phase):
        super(ExpPoseDB, self).__init__()
        self.config = config
        self.phase = phase
        ...
        self.rotate = transforms.RandomRotation(40)
        ...
        self.crop = transforms.CenterCrop(self.sz)
